...
<script type="text/javascript">
	/*
		...
		/ajax/send.jsp 페이지에 post방식으로 전송해 보세요.
		입력한 문자열은 msg라는 파라미터명으로 전송하기
		
		send.jsp 페이지에서는 전송된 내용을 서버측 콘솔에 출력해보세요.
		send.jsp 페이지에서는 응답은 json형식 {"isSuccess":true}를 응답해보세요.
		
		클라이언트에서는 서버가 응답한 데이터를 클라이언트측 콘솔에 출력해보세요.
	*/
