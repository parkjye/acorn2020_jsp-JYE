        ...
        if (formItems != null && formItems.size() > 0) {
            ...
            for (FileItem item : formItems) {
                ...
                if (!item.isFormField()) {//만일 파일 필드라면...
                	...
                	//저장할 파일명 구성(파일명 앞에 time stamp를 출력해서 겹치지 않게 한다.)
...
<body>
	<div class="container">
		<%if(isSuccess){ %>
			<p>이미지를 업로드 했습니다. <a href="../list.jsp"></a>확인</p>
		<%} else {%>
			<p>이미지 실패! <a href="upload_form.jsp">다시 시도</a></p>		
		<%} %>
	</div>
</body>
</html>
